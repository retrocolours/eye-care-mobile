        ...
        GeometryReader { geo in
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    BrandHeader(title: "Keep your Glasses On", topPadding: 0)
                    Text("Keep your glasses on during the test. Avoid wearing sunglasses or tinted colored lenses.")
...
// Preview
struct GlassesSelected_Preview: PreviewProvider {
